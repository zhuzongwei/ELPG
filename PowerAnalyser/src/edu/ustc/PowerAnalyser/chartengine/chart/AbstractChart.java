...
public class AbstractChart {
  ...
  protected CategorySeries buildCategoryDataset(String title, double[] values) {
    ...
    series.add("Sensor", values[0]);
    series.add("Screen", values[1]);
    series.add("WIFI", values[2]);
    series.add("Bluetooth", values[3]);
    series.add("CPU", values[4]);
    series.add("Phone", values[5]);
    return series;
  }
